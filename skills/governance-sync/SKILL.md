...
```text
python3 scripts/governance-sync.py adopt REPO --source CLAUDE.md --backup-dir BACKUPS
python3 scripts/governance-sync.py generate REPO --backup-dir BACKUPS
