...
- `/config` for response style: run `/config` to select Explanatory (step-by-step with rationale), Concise (brief action-focused), or Technical (precise, jargon-friendly). Set a preference in CLAUDE.md via a short note to keep the style consistent across sessions. <!-- Updated 2026-06-26: https://code.claude.com/docs/en/best-practices -->
