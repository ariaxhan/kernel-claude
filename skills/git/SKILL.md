...
<workflow>
  ...
  <step id="6" name="pr_review">
    ...
    30. **JiT tests as PR review evidence**: for AI-generated PRs, generate Just-in-Time behavioral tests against the diff before human review, run them, and include pass/fail output in the PR description. Tests written against the diff expose intent drift — behavior Claude correctly implemented vs. what was actually needed — more reliably than reading the code alone. Complements item 18 (pre-PR spec verification) with a runnable, reviewable signal. <!-- Updated 2026-06-29: https://mesrai.com/blog/the-complete-guide-to-ai-powered-code-reviews-in-2026 https://www.infoq.com/news/2026/04/meta-jit-testing-ai-detection/ -->
